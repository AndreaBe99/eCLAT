...
HIKE_CHAIN_1(HIKE_CHAIN_MYCHAIN2_ID) {
	__u8 allow;
	__u16 eth_type;
	__u8 hop_lim;
	allow = 1;
...
HIKE_CHAIN_3(HIKE_CHAIN_MYCHAIN5_ID, __u8 allow, __u16 eth_type) {
	__u32 prog_id;
	if (allow == 1) {
