...
def getParser(syntax_tokens, package_name="package_name"):
    ...
    @pg.production('statement : IF expression : NEWLINE block elif_stmt')
    @pg.production('statement : IF expression : NEWLINE block else_stmt')
    @pg.production('statement : IF expression : NEWLINE block')
    ...
    @pg.production('statement : IF expression : statement NEWLINE elif_stmt')
    @pg.production('statement : IF expression : statement NEWLINE else_stmt')
    @pg.production('statement : IF expression : statement_full')
    ...
    @pg.production('statement : WHILE expression : NEWLINE block ')
